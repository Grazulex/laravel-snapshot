...
# Script pour créer une release Laravel Snapshot
...
print_message $BLUE "   https://github.com/Grazulex/laravel-snapshot/actions/workflows/release.yml"
...
print_message $YELLOW "   - GitHub: https://github.com/Grazulex/laravel-snapshot/releases"
print_message $YELLOW "   - Packagist: https://packagist.org/packages/grazulex/laravel-snapshot"
